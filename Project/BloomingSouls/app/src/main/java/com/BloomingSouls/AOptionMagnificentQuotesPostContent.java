...
public class AOptionMagnificentQuotesPostContent extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == REQUESCODE && data != null) {
            ...
            if (data != null) {
                ...
                Intent intent = new Intent(getApplicationContext(), AOptionMagnificentQuotesPostContent.class);
    ...
    private void checkAndRequestForPermission() {
        if (ContextCompat.checkSelfPermission(AOptionMagnificentQuotesPostContent.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(AOptionMagnificentQuotesPostContent.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Toast.makeText(AOptionMagnificentQuotesPostContent.this, "Please accept the required permission.", Toast.LENGTH_SHORT).show();
            } else {
                ActivityCompat.requestPermissions(AOptionMagnificentQuotesPostContent.this,
    ...
    private void addPost(ClassBlogPost post) {
        ...
        DatabaseReference myRef = database.getReference("MagnificentQuotesPosts").push();
    ...
    private void showMessage(String message) {
        Toast.makeText(AOptionMagnificentQuotesPostContent.this, message, Toast.LENGTH_SHORT).show();
    }
    ...
    private void startCrop(@NonNull Uri uri) {
        ...
        uCrop.start(AOptionMagnificentQuotesPostContent.this);
    }
