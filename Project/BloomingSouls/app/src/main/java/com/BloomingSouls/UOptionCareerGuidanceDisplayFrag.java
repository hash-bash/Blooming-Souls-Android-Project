...
public class UOptionCareerGuidanceDisplayFrag extends Fragment {
    ...
    public UOptionCareerGuidanceDisplayFrag() {
    }

    public static UOptionCareerGuidanceDisplayFrag newInstance(String param1, String param2) {
        UOptionCareerGuidanceDisplayFrag fragment = new UOptionCareerGuidanceDisplayFrag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference = firebaseDatabase.getReference("CareerGuidancePosts");
        return fragmentView;
    }
