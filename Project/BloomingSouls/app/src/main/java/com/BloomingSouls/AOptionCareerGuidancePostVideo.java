...
public class AOptionCareerGuidancePostVideo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = database.getReference("CareerGuidanceVideos");
        ...
        searchBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!(youtubeId.getText().toString().isEmpty())) {
                    ...
                    Toast.makeText(AOptionCareerGuidancePostVideo.this, "Please enter YouTube video ID first.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        popupAddBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (imageUriResultCrop != null && !TextUtils.isEmpty(videoNameString) && !TextUtils.isEmpty(ytLink)) {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            imageFilePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(AOptionCareerGuidancePostVideo.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                    popupClickProgress.setVisibility(View.INVISIBLE);
                                    popupAddBtn.setVisibility(View.VISIBLE);
                                }
                            });
                    ...
                    popupAddBtn.setVisibility(View.VISIBLE);
                    popupClickProgress.setVisibility(View.INVISIBLE);
                    Toast.makeText(AOptionCareerGuidancePostVideo.this, "Please verify all input fields.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void checkAndRequestForPermission() {
        if (ContextCompat.checkSelfPermission(AOptionCareerGuidancePostVideo.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(AOptionCareerGuidancePostVideo.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Toast.makeText(AOptionCareerGuidancePostVideo.this, "Please accept the required permission.", Toast.LENGTH_SHORT).show();
            } else {
                ActivityCompat.requestPermissions(AOptionCareerGuidancePostVideo.this,
    ...
    private void addPost(ClassYoutube post) {
        ...
        DatabaseReference myRef = database.getReference("CareerGuidanceVideos").push();
        ...
        myRef.setValue(post).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                test[0] = true;
                Toast.makeText(AOptionCareerGuidancePostVideo.this, "Video Added Successfully", Toast.LENGTH_SHORT).show();
                popupClickProgress.setVisibility(View.INVISIBLE);
                popupAddBtn.setVisibility(View.VISIBLE);
                popAddPost.dismiss();
                finish();
        ...
        if (test[0]) {
            popupClickProgress.setVisibility(View.INVISIBLE);
            popupAddBtn.setVisibility(View.VISIBLE);
            Toast.makeText(AOptionCareerGuidancePostVideo.this, "Error Occurred!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void showDeleteDialog(final String name) {
        AlertDialog.Builder builder = new AlertDialog.Builder(AOptionCareerGuidancePostVideo.this, R.style.AlertDialogBox);
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                AlertDialog dialog = new SpotsDialog.Builder().setContext(AOptionCareerGuidancePostVideo.this).build();
                dialog.show();
                dialog.getWindow().setBackgroundDrawableResource(R.drawable.bg_white_card);
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        dialog.dismiss();
                        Toast.makeText(AOptionCareerGuidancePostVideo.this, "Video Deleted", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void startCrop(@NonNull Uri uri) {
        ...
        uCrop.start(AOptionCareerGuidancePostVideo.this);
    }
