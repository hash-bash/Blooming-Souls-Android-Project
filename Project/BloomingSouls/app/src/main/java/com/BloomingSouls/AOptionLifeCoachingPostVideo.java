...
public class AOptionLifeCoachingPostVideo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = database.getReference("LifeCoachingVideos");
        ...
        searchBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!(youtubeId.getText().toString().isEmpty())) {
                    ...
                    Toast.makeText(AOptionLifeCoachingPostVideo.this, "Please enter YouTube video ID first.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        popupAddBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (imageUriResultCrop != null && !TextUtils.isEmpty(videoNameString) && !TextUtils.isEmpty(ytLink)) {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            imageFilePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(AOptionLifeCoachingPostVideo.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                    popupClickProgress.setVisibility(View.INVISIBLE);
                                    popupAddBtn.setVisibility(View.VISIBLE);
                                }
                            });
                    ...
                    popupAddBtn.setVisibility(View.VISIBLE);
                    popupClickProgress.setVisibility(View.INVISIBLE);
                    Toast.makeText(AOptionLifeCoachingPostVideo.this, "Please verify all input fields.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void checkAndRequestForPermission() {
        if (ContextCompat.checkSelfPermission(AOptionLifeCoachingPostVideo.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(AOptionLifeCoachingPostVideo.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Toast.makeText(AOptionLifeCoachingPostVideo.this, "Please accept the required permission.", Toast.LENGTH_SHORT).show();
            } else {
                ActivityCompat.requestPermissions(AOptionLifeCoachingPostVideo.this,
    ...
    private void addPost(ClassYoutube post) {
        ...
        DatabaseReference myRef = database.getReference("LifeCoachingVideos").push();
        ...
        myRef.setValue(post).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                test[0] = true;
                Toast.makeText(AOptionLifeCoachingPostVideo.this, "Video Added Successfully", Toast.LENGTH_SHORT).show();
                popupClickProgress.setVisibility(View.INVISIBLE);
                popupAddBtn.setVisibility(View.VISIBLE);
                popAddPost.dismiss();
                finish();
        ...
        if (test[0]) {
            popupClickProgress.setVisibility(View.INVISIBLE);
            popupAddBtn.setVisibility(View.VISIBLE);
            Toast.makeText(AOptionLifeCoachingPostVideo.this, "Error Occurred!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void showDeleteDialog(final String name) {
        AlertDialog.Builder builder = new AlertDialog.Builder(AOptionLifeCoachingPostVideo.this, R.style.AlertDialogBox);
        builder.setTitle("Delete");
        builder.setMessage("Are you sure to delete this video?");
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                AlertDialog dialog = new SpotsDialog.Builder().setContext(AOptionLifeCoachingPostVideo.this).build();
                dialog.show();
                dialog.getWindow().setBackgroundDrawableResource(R.drawable.bg_white_card);
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        dialog.dismiss();
                        Toast.makeText(AOptionLifeCoachingPostVideo.this, "Video Deleted", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void startCrop(@NonNull Uri uri) {
        ...
        uCrop.start(AOptionLifeCoachingPostVideo.this);
    }
