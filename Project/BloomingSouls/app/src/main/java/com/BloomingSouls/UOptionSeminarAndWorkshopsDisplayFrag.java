...
public class UOptionSeminarAndWorkshopsDisplayFrag extends Fragment {
    ...
    public UOptionSeminarAndWorkshopsDisplayFrag() {
    }

    public static UOptionSeminarAndWorkshopsDisplayFrag newInstance(String param1, String param2) {
        UOptionSeminarAndWorkshopsDisplayFrag fragment = new UOptionSeminarAndWorkshopsDisplayFrag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference = firebaseDatabase.getReference("SeminarAndWorkshopsPosts");
        return fragmentView;
    }
