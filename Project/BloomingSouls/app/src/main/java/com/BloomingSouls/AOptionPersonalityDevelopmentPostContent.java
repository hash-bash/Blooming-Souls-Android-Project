...
public class AOptionPersonalityDevelopmentPostContent extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == REQUESCODE && data != null) {
            ...
            if (data != null) {
                ...
                Intent intent = new Intent(getApplicationContext(), AOptionPersonalityDevelopmentPostContent.class);
    ...
    private void checkAndRequestForPermission() {
        if (ContextCompat.checkSelfPermission(AOptionPersonalityDevelopmentPostContent.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(AOptionPersonalityDevelopmentPostContent.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Toast.makeText(AOptionPersonalityDevelopmentPostContent.this, "Please accept the required permission.", Toast.LENGTH_SHORT).show();
            } else {
                ActivityCompat.requestPermissions(AOptionPersonalityDevelopmentPostContent.this,
    ...
    private void addPost(ClassBlogPost post) {
        ...
        DatabaseReference myRef = database.getReference("PersonalityDevelopmentPosts").push();
    ...
    private void showMessage(String message) {
        Toast.makeText(AOptionPersonalityDevelopmentPostContent.this, message, Toast.LENGTH_SHORT).show();
    }
    ...
    private void startCrop(@NonNull Uri uri) {
        ...
        uCrop.start(AOptionPersonalityDevelopmentPostContent.this);
    }
