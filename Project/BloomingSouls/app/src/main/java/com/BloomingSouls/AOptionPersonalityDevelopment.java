...
public class AOptionPersonalityDevelopment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ao_personality_development);
        ...
        slide1.setOnSlideCompleteListener(new SlideToActView.OnSlideCompleteListener() {
            ...
            public void onSlideComplete(SlideToActView slideToActView) {
                Intent intent = new Intent(AOptionPersonalityDevelopment.this, AOptionPersonalityDevelopmentPostContent.class);
        ...
        slide2.setOnSlideCompleteListener(new SlideToActView.OnSlideCompleteListener() {
            @Override
            public void onSlideComplete(SlideToActView slideToActView) {
                Intent intent = new Intent(AOptionPersonalityDevelopment.this, AOptionPersonalityDevelopmentPostVideo.class);
                startActivity(intent);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                slide2.resetSlider();
            }
        ...
        slide3.setOnSlideCompleteListener(new SlideToActView.OnSlideCompleteListener() {
            @Override
            public void onSlideComplete(SlideToActView slideToActView) {
                Intent intent = new Intent(AOptionPersonalityDevelopment.this, AOptionPersonalityDevelopmentPostPdf.class);
                startActivity(intent);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                slide3.resetSlider();
            }
