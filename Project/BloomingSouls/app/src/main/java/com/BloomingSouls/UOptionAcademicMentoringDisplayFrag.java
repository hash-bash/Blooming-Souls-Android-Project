...
public class UOptionAcademicMentoringDisplayFrag extends Fragment {
    ...
    public UOptionAcademicMentoringDisplayFrag() {
    }

    public static UOptionAcademicMentoringDisplayFrag newInstance(String param1, String param2) {
        UOptionAcademicMentoringDisplayFrag fragment = new UOptionAcademicMentoringDisplayFrag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference = firebaseDatabase.getReference("AcademicMentoringPosts");
        return fragmentView;
    }
