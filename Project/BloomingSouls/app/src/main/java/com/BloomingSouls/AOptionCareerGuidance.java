...
public class AOptionCareerGuidance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ao_career_guidance);
        ...
        slide1.setOnSlideCompleteListener(new SlideToActView.OnSlideCompleteListener() {
            ...
            public void onSlideComplete(SlideToActView slideToActView) {
                Intent intent = new Intent(AOptionCareerGuidance.this, AOptionCareerGuidancePostContent.class);
        ...
        slide2.setOnSlideCompleteListener(new SlideToActView.OnSlideCompleteListener() {
            @Override
            public void onSlideComplete(SlideToActView slideToActView) {
                Intent intent = new Intent(AOptionCareerGuidance.this, AOptionCareerGuidancePostVideo.class);
                startActivity(intent);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                slide2.resetSlider();
            }
        ...
        slide3.setOnSlideCompleteListener(new SlideToActView.OnSlideCompleteListener() {
            @Override
            public void onSlideComplete(SlideToActView slideToActView) {
                Intent intent = new Intent(AOptionCareerGuidance.this, AOptionCareerGuidancePostPdf.class);
                startActivity(intent);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                slide3.resetSlider();
            }
