...
public class AOptionLifeCoachingPostPdf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference("LifeCoachingPdf");
    ...
    private void showDeleteDialog(final String name) {
        AlertDialog.Builder builder = new AlertDialog.Builder(AOptionLifeCoachingPostPdf.this, R.style.AlertDialogBox);
        builder.setTitle("Delete");
        builder.setMessage("Are you sure to delete this Pdf?");
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                AlertDialog dialog = new SpotsDialog.Builder().setContext(AOptionLifeCoachingPostPdf.this).build();
                dialog.show();
                dialog.getWindow().setBackgroundDrawableResource(R.drawable.bg_white_card);
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        dialog.dismiss();
                        Toast.makeText(AOptionLifeCoachingPostPdf.this, "Pdf Deleted", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void getPDF() {
        if (ContextCompat.checkSelfPermission(AOptionLifeCoachingPostPdf.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(AOptionLifeCoachingPostPdf.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {

                Toast.makeText(AOptionLifeCoachingPostPdf.this, "Please accept the required permission.", Toast.LENGTH_SHORT).show();

            } else {
                ActivityCompat.requestPermissions(AOptionLifeCoachingPostPdf.this,
        ...
        popupAddBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!popupTitle.getText().toString().isEmpty()
                    ...
                    final StorageReference sRef = mStorageReference.child("LifeCoachingPdf/" + System.currentTimeMillis() + ".pdf");
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            imageFilePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(AOptionLifeCoachingPostPdf.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                    popupClickProgress.setVisibility(View.INVISIBLE);
                                    popupAddBtn.setVisibility(View.VISIBLE);
                                }
                            });
