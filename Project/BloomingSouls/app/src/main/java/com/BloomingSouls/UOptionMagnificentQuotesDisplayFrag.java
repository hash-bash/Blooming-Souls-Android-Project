...
public class UOptionMagnificentQuotesDisplayFrag extends Fragment {
    ...
    public UOptionMagnificentQuotesDisplayFrag() {
    }

    public static UOptionMagnificentQuotesDisplayFrag newInstance(String param1, String param2) {
        UOptionMagnificentQuotesDisplayFrag fragment = new UOptionMagnificentQuotesDisplayFrag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference = firebaseDatabase.getReference("MagnificentQuotesPosts");
        return fragmentView;
    }
