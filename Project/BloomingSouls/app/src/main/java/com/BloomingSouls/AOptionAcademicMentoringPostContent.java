...
public class AOptionAcademicMentoringPostContent extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == REQUESCODE && data != null) {
            ...
            if (data != null) {
                ...
                Intent intent = new Intent(getApplicationContext(), AOptionAcademicMentoringPostContent.class);
    ...
    private void checkAndRequestForPermission() {
        if (ContextCompat.checkSelfPermission(AOptionAcademicMentoringPostContent.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(AOptionAcademicMentoringPostContent.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Toast.makeText(AOptionAcademicMentoringPostContent.this, "Please accept the required permission.", Toast.LENGTH_SHORT).show();
            } else {
                ActivityCompat.requestPermissions(AOptionAcademicMentoringPostContent.this,
    ...
    private void addPost(ClassBlogPost post) {
        ...
        DatabaseReference myRef = database.getReference("AcademicMentoringPosts").push();
    ...
    private void showMessage(String message) {
        Toast.makeText(AOptionAcademicMentoringPostContent.this, message, Toast.LENGTH_SHORT).show();
    }
    ...
    private void startCrop(@NonNull Uri uri) {
        ...
        uCrop.start(AOptionAcademicMentoringPostContent.this);
    }
