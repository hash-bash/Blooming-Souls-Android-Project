...
public class AOptionCareerGuidancePostPdf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference("CareerGuidancePdf");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_PDF_CODE && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            if (data != null) {
                ...
                Intent intent = new Intent(getApplicationContext(), AOptionCareerGuidancePostPdf.class);
    ...
    private void showDeleteDialog(final String name) {
        AlertDialog.Builder builder = new AlertDialog.Builder(AOptionCareerGuidancePostPdf.this, R.style.AlertDialogBox);
        builder.setTitle("Delete");
        builder.setMessage("Are you sure to delete this Pdf?");
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                AlertDialog dialog = new SpotsDialog.Builder().setContext(AOptionCareerGuidancePostPdf.this).build();
                dialog.show();
                dialog.getWindow().setBackgroundDrawableResource(R.drawable.bg_white_card);
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        dialog.dismiss();
                        Toast.makeText(AOptionCareerGuidancePostPdf.this, "Pdf Deleted", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void getPDF() {
        if (ContextCompat.checkSelfPermission(AOptionCareerGuidancePostPdf.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(AOptionCareerGuidancePostPdf.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Toast.makeText(AOptionCareerGuidancePostPdf.this, "Please accept the required permission.", Toast.LENGTH_SHORT).show();
            } else {
                ActivityCompat.requestPermissions(AOptionCareerGuidancePostPdf.this,
        ...
        popupAddBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!popupTitle.getText().toString().isEmpty()
                    ...
                    final StorageReference sRef = mStorageReference.child("CareerGuidancePdf/" + System.currentTimeMillis() + ".pdf");
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            imageFilePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri1) {
                                    String imageDownloadLink = uri1.toString();
                                    sRef.putFile(pdfUri)
                                                ...
                                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                                    ...
                                                    sRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                        ...
                                                        public void onSuccess(Uri uri2) {
                                                            ...
                                                            ClassPdf upload2 = new ClassPdf(popupTitle.getText().toString(), popupTitle.getText().toString().toLowerCase(), downloadUrl, imageDownloadLink);
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(AOptionCareerGuidancePostPdf.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                    popupClickProgress.setVisibility(View.INVISIBLE);
                                    popupAddBtn.setVisibility(View.VISIBLE);
                                }
                            });
    ...
    private void startCrop(@NonNull Uri uri) {
        ...
        uCrop.start(AOptionCareerGuidancePostPdf.this);
    }
