...
public class AOptionSeminarAndWorkshops extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ao_seminar_and_workshops);
        ...
        slide1.setOnSlideCompleteListener(new SlideToActView.OnSlideCompleteListener() {
            ...
            public void onSlideComplete(SlideToActView slideToActView) {
                Intent intent = new Intent(AOptionSeminarAndWorkshops.this, AOptionSeminarAndWorkshopsPostContent.class);
