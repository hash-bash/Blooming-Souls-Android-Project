...
public class ActivityChatUser extends BaseBottomNavigationActivityUser implements OfflineConnectivityReceiver.ConnectivityReceiverListener {
    ...
    private void changeActivity() {
        String activityName = "ActivityChatUser.class";
        Intent intent = new Intent(ActivityChatUser.this, OfflineAlertIntent.class);
