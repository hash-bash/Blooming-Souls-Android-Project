...
public class AOptionCareerGuidancePostContent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.PostFrameContainer, new UOptionCareerGuidanceDisplayFrag()).commit();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == REQUESCODE && data != null) {
            ...
            if (data != null) {
                ...
                Intent intent = new Intent(getApplicationContext(), AOptionCareerGuidancePostContent.class);
    ...
    private void checkAndRequestForPermission() {
        if (ContextCompat.checkSelfPermission(AOptionCareerGuidancePostContent.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(AOptionCareerGuidancePostContent.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Toast.makeText(AOptionCareerGuidancePostContent.this, "Please accept the required permission.", Toast.LENGTH_SHORT).show();
            } else {
                ActivityCompat.requestPermissions(AOptionCareerGuidancePostContent.this,
    ...
    private void addPost(ClassBlogPost post) {
        ...
        DatabaseReference myRef = database.getReference("CareerGuidancePosts").push();
    ...
    private void showMessage(String message) {
        Toast.makeText(AOptionCareerGuidancePostContent.this, message, Toast.LENGTH_SHORT).show();
    }
    ...
    private void startCrop(@NonNull Uri uri) {
        ...
        uCrop.start(AOptionCareerGuidancePostContent.this);
    }
