...
public class AOptionAcademicMentoringPostPdf extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_PDF_CODE && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            if (data != null) {
                ...
                Intent intent = new Intent(getApplicationContext(), AOptionAcademicMentoringPostPdf.class);
    ...
    private void showDeleteDialog(final String name) {
        AlertDialog.Builder builder = new AlertDialog.Builder(AOptionAcademicMentoringPostPdf.this, R.style.AlertDialogBox);
        builder.setTitle("Delete");
        builder.setMessage("Are you sure to delete this Pdf?");
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                AlertDialog dialog = new SpotsDialog.Builder().setContext(AOptionAcademicMentoringPostPdf.this).build();
                dialog.show();
                dialog.getWindow().setBackgroundDrawableResource(R.drawable.bg_white_card);
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        dialog.dismiss();
                        Toast.makeText(AOptionAcademicMentoringPostPdf.this, "Pdf Deleted", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void getPDF() {
        if (ContextCompat.checkSelfPermission(AOptionAcademicMentoringPostPdf.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(AOptionAcademicMentoringPostPdf.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Toast.makeText(AOptionAcademicMentoringPostPdf.this, "Please accept the required permission.", Toast.LENGTH_SHORT).show();
            } else {
                ActivityCompat.requestPermissions(AOptionAcademicMentoringPostPdf.this,
        ...
        popupAddBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!popupTitle.getText().toString().isEmpty()
                    ...
                    final StorageReference sRef = mStorageReference.child("AcademicMentoringPdf/" + System.currentTimeMillis() + ".pdf");
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            imageFilePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(AOptionAcademicMentoringPostPdf.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                    popupClickProgress.setVisibility(View.INVISIBLE);
                                    popupAddBtn.setVisibility(View.VISIBLE);
                                }
                            });
    ...
    private void startCrop(@NonNull Uri uri) {
        ...
        uCrop.start(AOptionAcademicMentoringPostPdf.this);
    }
