...
public class UOptionLifeCoachingDisplayFrag extends Fragment {
    ...
    public UOptionLifeCoachingDisplayFrag() {
    }

    public static UOptionLifeCoachingDisplayFrag newInstance(String param1, String param2) {
        UOptionLifeCoachingDisplayFrag fragment = new UOptionLifeCoachingDisplayFrag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference = firebaseDatabase.getReference("LifeCoachingPosts");
        return fragmentView;
    }
