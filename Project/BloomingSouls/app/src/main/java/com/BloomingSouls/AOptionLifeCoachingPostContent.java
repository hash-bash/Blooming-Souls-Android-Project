...
public class AOptionLifeCoachingPostContent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.PostFrameContainer, new UOptionLifeCoachingDisplayFrag()).commit();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == REQUESCODE && data != null) {
            ...
            if (data != null) {
                ...
                Intent intent = new Intent(getApplicationContext(), AOptionLifeCoachingPostContent.class);
    ...
    private void checkAndRequestForPermission() {
        if (ContextCompat.checkSelfPermission(AOptionLifeCoachingPostContent.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(AOptionLifeCoachingPostContent.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Toast.makeText(AOptionLifeCoachingPostContent.this, "Please accept the required permission.", Toast.LENGTH_SHORT).show();
            } else {
                ActivityCompat.requestPermissions(AOptionLifeCoachingPostContent.this,
    ...
    private void addPost(ClassBlogPost post) {
        ...
        DatabaseReference myRef = database.getReference("LifeCoachingPosts").push();
    ...
    private void showMessage(String message) {
        Toast.makeText(AOptionLifeCoachingPostContent.this, message, Toast.LENGTH_SHORT).show();
    }
    ...
    private void startCrop(@NonNull Uri uri) {
        ...
        uCrop.start(AOptionLifeCoachingPostContent.this);
    }
